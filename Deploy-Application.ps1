...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path "$dirFiles\gimp-2.10.20-setup-1.exe" -Parameters '/verysilent /NORESTART /SUPPRESSMSGBOXES /SP' -WindowStyle 'Hidden'
