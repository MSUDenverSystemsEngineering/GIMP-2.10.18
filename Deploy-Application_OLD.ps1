...
Try {
	...
	[string]$appVendor = 'Gimp.org'
	[string]$appName = 'GIMP'
	[string]$appVersion = '2.10.12'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '10/09/2019'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'gimp-2.10' -CheckDiskSpace -PersistPrompt
        ...
        Execute-Process -Path "$dirFiles\gimp-2.10.12-setup-3.exe" -Parameters '/verysilent /NORESTART /SUPPRESSMSGBOXES /SP' -WindowStyle 'Hidden'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'gimp-2.10' -CloseAppsCountdown 60
		...
		# <Perform Uninstallation tasks here>
          Execute-Process -Path "$envProgramFiles\GIMP 2\uninst\unins000.exe" -Parameters '/VERYSILENT' -WindowStyle 'Hidden'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU9sgQWmfexJnakP71TrYhFSn5
# RzSggguhMIIFrjCCBJagAwIBAgIQBwNx0Q95WkBxmSuUB2Kb4jANBgkqhkiG9w0B
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQKiH2TdqxojGPT
# hw9La8u0dAHDjzANBgkqhkiG9w0BAQEFAASCAQAhS3wGObbBrQfUG92z1alKbi9L
# T5UCH5AY2dAoEJDxdxnJ6RKRjdacR8gBlq2QGigkoMTSikxxOCZfrhdCRX6vfF+N
# U06a6J/e4maEzjG3asj4hk70Uzj0QA0XiwxvFxKzAug4yZVPpRneW4AOGOvGv5Rx
# Ho2tXED3VWKo/Zcf0d/fC2fOE3C/Ag2ix9D27hzvKPriHqWy/RNmt7bxxJ3hsfMW
# v3eE6ksHZjpfrx/SyX8o9lYW9YY9Xq14YoAsMuIgn5bZUjdLxHFzGXXjpHAAEnUz
# 1VbvwL3jLGTk6DdvKeLCEp49zRUTyHf0RPks7NKvGFjLacubfoZF8ZqBb6aF
